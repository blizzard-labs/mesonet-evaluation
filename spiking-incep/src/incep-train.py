...
#create networks
net['M1'] = Network(neuron_groups['A1'],neuron_groups['X1'],neuron_groups['A2'],connections['X1A1'],connections['A1A1'],connections['A1A2'],spike_counters['A1'],spike_counters['A2'])
#-----------------------------------------------------------------------------------------------------------------------
